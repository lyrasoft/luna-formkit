...
#[Repository(entityClass: FormkitResponse::class)]
class FormkitResponseRepository implements ManageRepositoryInterface, ListRepositoryInterface
{
    ...
    public function getListSelector(): ListSelector
    {
        ...
        $selector->from(FormkitResponse::class);
